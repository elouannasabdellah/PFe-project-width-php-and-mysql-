...
<?php
    ...
    if(isset( $_SESSION['ResId'])){
        ...
        <form method="POST" class="container  mt-5 shadow p-3 mb-5 bg-body rounded" >
             ...
             <div class="p-2 fw-bold"> Message</div>
                <textarea class="form-control" placeholder="Votre message" name="message" value="'.$user->ETAT.'" id="floatingTextarea" required></textarea>
    ...
    if(isset($_POST['message_Reservation'])){
        ...
        $updateR->bindParam("etat",$_POST['message']);
